...
package com.OsMoDroid;import java.io.BufferedReader;import java.io.IOException;import java.io.InputStream;import java.io.InputStreamReader;import java.io.PrintWriter;import java.net.HttpURLConnection;import java.net.InetSocketAddress;import java.net.Proxy;import java.net.URL;import java.net.UnknownHostException;import java.text.SimpleDateFormat;import java.util.ArrayList;import java.util.Date;import java.util.Iterator;import org.json.JSONArray;import org.json.JSONException;import org.json.JSONObject;import com.OsMoDroid.LocalService.SendCoor;import android.app.Notification;import android.app.PendingIntent;import android.app.PendingIntent.CanceledException;import android.content.BroadcastReceiver;import android.content.Context;import android.content.Intent;import android.content.IntentFilter;import android.net.NetworkInfo;import android.os.Bundle;import android.os.Handler;import android.os.Message;import android.support.v4.app.NotificationCompat;import android.util.Log;import android.widget.Toast;public class IM {	protected boolean running       = false;	protected boolean connected     = false;	protected boolean autoReconnect = true;	protected Integer timeout       = 0;	private HttpURLConnection con;	private InputStream instream;	String adr;	String timestamp=Long.toString(System.currentTimeMillis());	int pingTimeout=900;	Thread myThread;	private BufferedReader    in      = null;	Context parent;	String mychanel;
	ArrayList<String>  mychannelsList;	//ArrayList<String> list= new ArrayList<String>();	int mestype=0;	final private static SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");	public IM(ArrayList<String> channelsList, Context context,int type) {
		...
		this.parent=context;
		mychannelsList=channelsList;
		getadres(channelsList);
		mestype=type;
		parent.registerReceiver(bcr, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
		start();
	}

	private void getadres(ArrayList<String> channelsList) {
		adr="http://d.esya.ru/?identifier=";
		for (String str : channelsList){
			adr=adr+str+",";
		}
		adr.substring(0, adr.length()-1);
		adr=adr+"&ncrnd="+timestamp;
		Log.d(this.getClass().getName(), "IM adr="+adr);
	}
	
	public void addchannels(ArrayList<String> channelsList){
		parent.unregisterReceiver(bcr);
		stop();
		mychannelsList.addAll(channelsList);
		getadres(mychannelsList);
		parent.registerReceiver(bcr, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
		start();

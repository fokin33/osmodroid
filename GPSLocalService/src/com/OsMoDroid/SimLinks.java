...
public class SimLinks extends Activity implements ResultsListener{
	...
	void reflinks(){
		String[] params = {
				"http://api.esya.ru/?system=om&action=device_get_links&hash="+settings.getString("hash", "")+"&n="+Integer.parseInt(settings.getString("n", "0").equals("") ? "0"
						: settings.getString("n", "0"))
						+ "&key="
						+ GPSLocalServiceClient.key
						+ "&signature="
						+ GPSLocalServiceClient.SHA1(
								"system:om;action:device_get_links;hash:"+settings.getString("hash", "")+";n:"+Integer.parseInt(settings.getString("n", "0").equals("") ? "0"
	...
	void addlink(){
		//--
		//[19:27:37.138] GET http://api.esya.ru/?system=om&key=H83_fdDGd34i85gDsd4f&action=add_link&url=zxccvb&item=764&type=0&on=2012-08-16%2019:27:00&off=2012-08-17%2000:00:00&format=jsonp&callback=jQuery17107581103815227868_1345130731429&_=1345130857118 [HTTP/1.1 200 OK 122��]
		String[] params = {
